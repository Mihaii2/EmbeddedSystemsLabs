      ...
      000003 02 00 62         [24]  303 	ljmp	_main
                                    ...
                                    315 ;direction                 Allocated to registers r6 
                                    316 ;------------------------------------------------------------
                                    317 ;	.\shift.c:3: int main(int argc, char** argv) {
                                    318 ;	-----------------------------------------
                                    319 ;	 function main
                                    320 ;	-----------------------------------------
      000062                        321 _main:
                           ...
                           000000   329 	ar0 = 0x00
                                    330 ;	.\shift.c:5: x = 1;
      000062 7F 01            [12]  331 	mov	r7,#0x01
                                    332 ;	.\shift.c:6: int direction = 1;
      000064 7E 01            [12]  333 	mov	r6,#0x01
                                    334 ;	.\shift.c:7: while(1) {
      000066                        335 00110$:
                                    336 ;	.\shift.c:8: if(direction == 1) {
      000066 BE 01 07         [24]  337 	cjne	r6,#0x01,00102$
                                    338 ;	.\shift.c:9: x = x << 1; 
      000069 8F 05            [24]  339 	mov	ar5,r7
      00006B ED               [12]  340 	mov	a,r5
      00006C 2D               [12]  341 	add	a,r5
      00006D FF               [12]  342 	mov	r7,a
      00006E 80 04            [24]  343 	sjmp	00103$
      000070                        344 00102$:
                                    345 ;	.\shift.c:12: x = x >> 1;
      000070 EF               [12]  346 	mov	a,r7
      000071 C3               [12]  347 	clr	c
      000072 13               [12]  348 	rrc	a
      000073 FF               [12]  349 	mov	r7,a
      000074                        350 00103$:
                                    351 ;	.\shift.c:14: if(x == 1 << 7) {
      000074 BF 80 04         [24]  352 	cjne	r7,#0x80,00107$
                                    353 ;	.\shift.c:15: direction = 0;
      000077 7E 00            [12]  354 	mov	r6,#0x00
      000079 80 05            [24]  355 	sjmp	00108$
      00007B                        356 00107$:
                                    357 ;	.\shift.c:17: else if(x == 1) {
      00007B BF 01 02         [24]  358 	cjne	r7,#0x01,00108$
                                    359 ;	.\shift.c:18: direction = 1;
      00007E 7E 01            [12]  360 	mov	r6,#0x01
      000080                        361 00108$:
                                    362 ;	.\shift.c:20: P1 = ~x;
      000080 EF               [12]  363 	mov	a,r7
      000081 F4               [12]  364 	cpl	a
      000082 F5 90            [12]  365 	mov	_P1,a
                                    366 ;	.\shift.c:22: }
      000084 80 E0            [24]  367 	sjmp	00110$
                                    368 	.area CSEG    (CODE)
                                    369 	.area CONST   (CODE)
                                    370 	.area XINIT   (CODE)

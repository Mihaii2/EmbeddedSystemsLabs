      ...
      000062                        315 _main:
                           ...
                           000000   323 	ar0 = 0x00
                                    ...
                                    325 ;	assignBit
      000062 C2 B3            [12]  326 	clr	_P3_3
                                    327 ;	.\display.c:5: P3_4 = 0;
                                    328 ;	assignBit
      000064 C2 B4            [12]  329 	clr	_P3_4
                                    330 ;	.\display.c:7: int direction = 1;
      000066 7F 01            [12]  331 	mov	r7,#0x01
                                    332 ;	.\display.c:8: while(1) {
      000068                        333 00121$:
                                    334 ;	.\display.c:9: P1 = 0b10001000;
      000068 75 90 88         [24]  335 	mov	_P1,#0x88
                                    336 ;	.\display.c:11: if (direction == 1) {
      00006B BF 01 1D         [24]  337 	cjne	r7,#0x01,00118$
                                    338 ;	.\display.c:12: if(P3_3 == 0) {
      00006E 20 B3 04         [24]  339 	jb	_P3_3,00104$
                                    340 ;	.\display.c:13: P3_3 = 1;
                                    341 ;	assignBit
      000071 D2 B3            [12]  342 	setb	_P3_3
      000073 80 07            [24]  343 	sjmp	00105$
      000075                        344 00104$:
                                    345 ;	.\display.c:15: else if(P3_4 == 0) {
      000075 20 B4 04         [24]  346 	jb	_P3_4,00105$
                                    347 ;	.\display.c:16: P3_4 = 1;
                                    348 ;	assignBit
      000078 D2 B4            [12]  349 	setb	_P3_4
                                    350 ;	.\display.c:17: P3_3 = 0;
                                    351 ;	assignBit
      00007A C2 B3            [12]  352 	clr	_P3_3
      00007C                        353 00105$:
                                    354 ;	.\display.c:20: if(P3_3 == 1 && P3_4 == 1) {
      00007C 30 B3 E9         [24]  355 	jnb	_P3_3,00121$
      00007F 30 B4 E6         [24]  356 	jnb	_P3_4,00121$
                                    357 ;	.\display.c:21: direction = 1 - direction;
      000082 74 01            [12]  358 	mov	a,#0x01
      000084 C3               [12]  359 	clr	c
      000085 9F               [12]  360 	subb	a,r7
      000086 FF               [12]  361 	mov	r7,a
                                    362 ;	.\display.c:22: P3_3 = 0;
                                    363 ;	assignBit
      000087 C2 B3            [12]  364 	clr	_P3_3
      000089 80 DD            [24]  365 	sjmp	00121$
      00008B                        366 00118$:
                                    367 ;	.\display.c:26: if(P3_3 == 1) {
                                    368 ;	.\display.c:27: P3_3 = 0;
                                    369 ;	assignBit
      00008B 10 B3 07         [24]  370 	jbc	_P3_3,00113$
                                    371 ;	.\display.c:29: else if(P3_4 == 1) {
      00008E 30 B4 04         [24]  372 	jnb	_P3_4,00113$
                                    373 ;	.\display.c:31: P3_3 == 1;
      000091 A2 B4            [12]  374 	mov	c,_P3_4
      000093 A2 B3            [12]  375 	mov	c,_P3_3
      000095                        376 00113$:
                                    377 ;	.\display.c:34: if(P3_3 == 0 && P3_4 == 0) {
      000095 20 B3 D0         [24]  378 	jb	_P3_3,00121$
      000098 20 B4 CD         [24]  379 	jb	_P3_4,00121$
                                    380 ;	.\display.c:35: direction = 1 - direction;
      00009B 74 01            [12]  381 	mov	a,#0x01
      00009D C3               [12]  382 	clr	c
      00009E 9F               [12]  383 	subb	a,r7
      00009F FF               [12]  384 	mov	r7,a
                                    385 ;	.\display.c:36: P3_3 = 1;
                                    386 ;	assignBit
      0000A0 D2 B3            [12]  387 	setb	_P3_3
                                    388 ;	.\display.c:40: }
      0000A2 80 C4            [24]  389 	sjmp	00121$
                                    390 	.area CSEG    (CODE)
                                    391 	.area CONST   (CODE)
                                    392 	.area XINIT   (CODE)

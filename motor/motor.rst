      ...
      000003 02 00 62         [24]  300 	ljmp	_main
                                    ...
                                    308 ;------------------------------------------------------------
                                    309 ;turn                      Allocated to registers 
                                    310 ;------------------------------------------------------------
                                    311 ;	.\motor.c:3: int main(void) {
                                    312 ;	-----------------------------------------
                                    313 ;	 function main
                                    314 ;	-----------------------------------------
      000062                        315 _main:
                           ...
                           000001   322 	ar1 = 0x01
                           000000   323 	ar0 = 0x00
                                    324 ;	.\motor.c:5: while(1) {
      000062                        325 00108$:
                                    326 ;	.\motor.c:6: if(P2_0 == P2_1) {
      000062 A2 A0            [12]  327 	mov	c,_P2_0
      000064 20 A1 01         [24]  328 	jb	_P2_1,00130$
      000067 B3               [12]  329 	cpl	c
      000068                        330 00130$:
      000068 50 06            [24]  331 	jnc	00105$
                                    332 ;	.\motor.c:7: P3_0 = 0;
                                    333 ;	assignBit
      00006A C2 B0            [12]  334 	clr	_P3_0
                                    335 ;	.\motor.c:8: P3_1 = 0;
                                    336 ;	assignBit
      00006C C2 B1            [12]  337 	clr	_P3_1
      00006E 80 F2            [24]  338 	sjmp	00108$
      000070                        339 00105$:
                                    340 ;	.\motor.c:10: else if(P2_1 == 1) {
      000070 30 A1 06         [24]  341 	jnb	_P2_1,00102$
                                    342 ;	.\motor.c:11: P3_0 = 0;
                                    343 ;	assignBit
      000073 C2 B0            [12]  344 	clr	_P3_0
                                    345 ;	.\motor.c:12: P3_1 = 1;
                                    346 ;	assignBit
      000075 D2 B1            [12]  347 	setb	_P3_1
      000077 80 E9            [24]  348 	sjmp	00108$
      000079                        349 00102$:
                                    350 ;	.\motor.c:15: P3_0 = 1;
                                    351 ;	assignBit
      000079 D2 B0            [12]  352 	setb	_P3_0
                                    353 ;	.\motor.c:16: P3_1 = 0;
                                    354 ;	assignBit
      00007B C2 B1            [12]  355 	clr	_P3_1
                                    356 ;	.\motor.c:19: }
      00007D 80 E3            [24]  357 	sjmp	00108$
                                    358 	.area CSEG    (CODE)
                                    359 	.area CONST   (CODE)
                                    360 	.area XINIT   (CODE)
